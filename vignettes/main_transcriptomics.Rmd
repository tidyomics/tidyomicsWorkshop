...
bibliography: "`r file.path(system.file(package='TidyGenomicsTranscriptomicsWorkshopBioc2023', 'vignettes'), 'tidytranscriptomics.bib')`"
vignette: >
...
We will use the Cloud during the workshop and this method is available if you want to run the material after the workshop. If you want to install on your own computer, see instructions [here](https://tidy-biology.github.io/TidyGenomicsTranscriptomicsWorkshop_bioc2023/index.html#workshop-package-installation).

Alternatively, you can view the material at the workshop webpage [here](https://tidy-biology.github.io/TidyGenomicsTranscriptomicsWorkshop_bioc2023/articles/main.html).

## Introduction to tidytranscriptomics

[Here](https://docs.google.com/gview?url=https://raw.githubusercontent.com/tidy-biology/TidyGenomicsTranscriptomicsWorkshop_bioc2023/master/inst/tidytranscriptomics_slides.pdf)

<iframe 
src="https://docs.google.com/gview?url=https://raw.githubusercontent.com/tidy-biology/TidyGenomicsTranscriptomicsWorkshop_bioc2023/master/inst/tidytranscriptomics_slides.pdf&embedded=true" 
scrolling="yes" 
...
seurat_obj <- TidyGenomicsTranscriptomicsWorkshopBioc2023::seurat_obj
...
seurat_obj |>
	...
	TidyGenomicsTranscriptomicsWorkshopBioc2023::theme_multipanel
```
...
seurat_obj_UMAP3 <- TidyGenomicsTranscriptomicsWorkshopBioc2023::seurat_obj_UMAP3
