...
seurat_obj |>
  ...
  mutate(gate = gate_int(
    ...
    .size = 0.1,
    .color =signature_score,
    gate_list = TidyGenomicsTranscriptomicsWorkshop::gate_seurat_obj
  ))
...
seurat_obj_gamma_delta <-
  ...
  mutate(gate = gate_int(UMAP_1, UMAP_2, gate_list = TidyGenomicsTranscriptomicsWorkshop::gate_seurat_obj)) |>
